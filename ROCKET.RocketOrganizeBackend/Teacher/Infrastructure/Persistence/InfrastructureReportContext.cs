...
public class InfrastructureReportContext : DbContext
{
    public InfrastructureReportContext(DbContextOptions<InfrastructureReportContext> options) : base(options) { }
